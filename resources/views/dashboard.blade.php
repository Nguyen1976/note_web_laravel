        ...
        function displayNotes(notesData) {
            ...
            <div class="w-full h-64 flex flex-col justify-between bg-white rounded-lg border mb-6 py-5 px-4 shadow-md note-card-item">
                <div class="border-l-2 pl-3 ml-1" style="border-color: ${categoryColor};">
                    <h4 class="font-bold mb-3" style="color: ${categoryColor};">${note.title}</h4>
                    <p class="text-sm" style="color: ${categoryColor};">${note.content ? note.content.substring(0, 100) + (note.content.length > 100 ? '...' : '') : ''}</p>
                </div>
                <div>
                    ...
                    <div class="flex items-center justify-between" style="color: ${categoryColor}">
                        ...
                        <div class="flex items-center justify-center gap-3">
                            <div x-data="{ showModal: false }" @keydown.escape.window="showModal = false" class="flex">
                                <button @click="showModal = true" aria-label="Delete note" class="text-gray-500 hover:text-red-500" style="color: ${categoryColor};">
                            ...
                            <a href="/notes/${note.id}/edit" aria-label="Edit note" class="hover:text-blue-500" style="color: ${categoryColor};">
